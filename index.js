...
var util = require("util"),
    ...
    program = new commander.Command("aeolusx");
...
var tool = (function() {
    ...
    function main() {
        program
            .version("0.1.0")
            .description("Web-sites malware scanner.")
        ...
        program.on("--help", function () {
            ...
            console.log("    $ aeolusx -r /var/www/htdocs\n");
            console.log("Check only JavaScript in /var/www/htdocs folder and show the list of all checked files\n");
            console.log("    $ aeolusx -r -v --include \\.js$ /var/www/htdocs");
            console.log("Add WordPress to whitelist\n");
            console.log("    $ aeolusx --update-whitelist -w ./whitelist.sqlite -p \"WordPress 4.3.1\" ./temp/wordpress");
            console.log("Check all files in /var/www/htdocs folder using whitelist\n");
            console.log("    $ aeolusx -r -w ./whitelist.sqlite /var/www/htdocs\n");
        });
